        ...
        <View className="flex" pdfMode={pdfMode}>
          <View className="w-50" pdfMode={pdfMode}>
            ...
            <EditableInput
              placeholder="Cif"
              value={invoice.cif}
              onChange={(value) => handleChange('cif', value)}
              pdfMode={pdfMode}
            />
            <EditableInput
          ...
          <View className="w-50" pdfMode={pdfMode}>
            <EditableInput
              className="fs-30 color-primary right bold"
              placeholder="Factura"
              value={invoice.title}
            ...
            <View className="flex mb-5" pdfMode={pdfMode}>
              <View className="w-100" pdfMode={pdfMode}>
                <EditableInput
                  ...
                  title="Numero identificativo de la factura"
            ...
            <View key={i} className="row flex" pdfMode={pdfMode}>
              <View className="w-48 p-4-8 pb-10" pdfMode={pdfMode}>
                <EditableTextarea
                  className="dark"
                  rows={1}
                  placeholder="Nombre del articulo o descripción"
